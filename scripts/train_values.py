...
args=load_experiment_params(f"logs/configs/{dataset}/{dataset}-medium-expert-v2/configs_value.txt")
...
exp_name=f"H{args["horizon"]}_T{args["n_diffusion_steps"]}_d{args["discount"]}"
current_dir=os.getcwd()
savepath=os.path.join(current_dir,args["logbase"], args["dataset_name"],"values", exp_name)
